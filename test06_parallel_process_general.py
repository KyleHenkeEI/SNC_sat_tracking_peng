...
def process_single_case(camera, tile, method, iqr_factor, downsample_factor, output_dir, dataset):
...
def main():
    ...
    parser.add_argument('dataset', choices=['YAOGAN_30', 'STARLINK_30254', '2025_12'],
    ...
    # Prepare arguments for starmap (add output_dir and dataset to each case)
    starmap_args = [(cam, tile, method, iqr, factor, args.output_dir, args.dataset)
